        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <Link href="https://x.com/physova" className="p-2 bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 transition-all text-white/60 hover:text-white flex items-center justify-center fill-current">
