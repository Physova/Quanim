...
### 6. Labels Overlap Header/Buttons in Hover Mode
**Problem:** Live data or equation labels cover the simulation title or share buttons.
**Fix:** See the "Label Positioning & Overlap Avoidance" section below. NEVER place labels at y > 2.5 or x > 4.
